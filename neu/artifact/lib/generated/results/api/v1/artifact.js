...
exports.ArtifactService =
  ...
  exports.GetSignedArtifactURLRequest =
  exports.ListArtifactsResponse_MonolithArtifact =
...
class FinalizeArtifactRequest$Type extends runtime_5.MessageType {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue hash */ 5:
          message.hash = wrappers_2.StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.hash
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.hash)
      wrappers_2.StringValue.internalBinaryWrite(
        message.hash,
...
class ListArtifactsRequest$Type extends runtime_5.MessageType {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue name_filter */ 3:
          message.nameFilter = wrappers_2.StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.nameFilter
        ...
        case /* google.protobuf.Int64Value id_filter */ 4:
          message.idFilter = wrappers_1.Int64Value.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.idFilter
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.idFilter)
      wrappers_1.Int64Value.internalBinaryWrite(
        message.idFilter,
        writer.tag(4, runtime_1.WireType.LengthDelimited).fork(),
        options
      ).join()
...
class ListArtifactsResponse$Type extends runtime_5.MessageType {
      ...
      switch (fieldNo) {
        case /* repeated github.actions.results.api.v1.ListArtifactsResponse.MonolithArtifact artifacts */ 1:
          message.artifacts.push(
            exports.ListArtifactsResponse_MonolithArtifact.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    for (let i = 0; i < message.artifacts.length; i++)
      exports.ListArtifactsResponse_MonolithArtifact.internalBinaryWrite(
        message.artifacts[i],
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Timestamp created_at */ 6:
          message.createdAt = timestamp_1.Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.createdAt
