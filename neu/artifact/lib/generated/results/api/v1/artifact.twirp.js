...
class ArtifactServiceClientJSON {
  ...
  ListArtifacts(request) {
    ...
    return promise.then((data) =>
      artifact_1.ListArtifactsResponse.fromJson(data, {
        ignoreUnknownFields: true
      })
    )
  }
  GetSignedArtifactURL(request) {
    ...
    return promise.then((data) =>
      artifact_1.GetSignedArtifactURLResponse.fromJson(data, {
        ignoreUnknownFields: true
      })
    )
  }
...
class ArtifactServiceClientProtobuf {
  ...
  ListArtifacts(request) {
    ...
    return promise.then((data) =>
      artifact_1.ListArtifactsResponse.fromBinary(data)
    )
  }
  GetSignedArtifactURL(request) {
    ...
    return promise.then((data) =>
      artifact_1.GetSignedArtifactURLResponse.fromBinary(data)
    )
  }
}
...
;(function (ArtifactServiceMethod) {
  ...
  ArtifactServiceMethod ||
    (exports.ArtifactServiceMethod = ArtifactServiceMethod = {})
)
exports.ArtifactServiceMethodList = [
  ...
  switch (method) {
    ...
    case 'GetSignedArtifactURL':
      return (ctx, service, data, interceptors) =>
        __awaiter(this, void 0, void 0, function* () {
          ctx = Object.assign(Object.assign({}, ctx), {
            methodName: 'GetSignedArtifactURL'
          })
          yield events.onMatch(ctx)
...
function handleArtifactServiceListArtifactsRequest(
  ...
  switch (ctx.contentType) {
    case twirp_ts_1.TwirpContentType.JSON:
      return handleArtifactServiceListArtifactsJSON(
        ctx,
        service,
        data,
        interceptors
    ...
    case twirp_ts_1.TwirpContentType.Protobuf:
      return handleArtifactServiceListArtifactsProtobuf(
        ctx,
        service,
        data,
        interceptors
...
function handleArtifactServiceGetSignedArtifactURLRequest(
  ...
  switch (ctx.contentType) {
    case twirp_ts_1.TwirpContentType.JSON:
      return handleArtifactServiceGetSignedArtifactURLJSON(
        ctx,
        service,
        data,
        interceptors
    ...
    case twirp_ts_1.TwirpContentType.Protobuf:
      return handleArtifactServiceGetSignedArtifactURLProtobuf(
        ctx,
        service,
        data,
        interceptors
...
function handleArtifactServiceListArtifactsJSON(
  ctx,
  service,
  data,
  interceptors
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return JSON.stringify(
      artifact_1.ListArtifactsResponse.toJson(response, {
        useProtoFieldName: true,
        emitDefaultValues: false
      })
    )
...
function handleArtifactServiceGetSignedArtifactURLJSON(
  ctx,
  service,
  data,
  interceptors
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return JSON.stringify(
      artifact_1.GetSignedArtifactURLResponse.toJson(response, {
        useProtoFieldName: true,
        emitDefaultValues: false
      })
    )
...
function handleArtifactServiceGetSignedArtifactURLProtobuf(
  ctx,
  service,
  data,
  interceptors
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return Buffer.from(
      artifact_1.GetSignedArtifactURLResponse.toBinary(response)
    )
  })
}
