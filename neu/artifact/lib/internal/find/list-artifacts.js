...
function listArtifactsPublic(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let artifacts = []
    const [retryOpts, requestOpts] = (0, retry_options_1.getRetryOptions)(
      utils_1.defaults
    )
    const opts = {
      log: undefined,
    ...
    const github = (0, github_1.getOctokit)(
      token,
      opts,
      plugin_retry_1.retry,
      plugin_request_log_1.requestLog
    )
    let currentPageNumber = 1
    const { data: listArtifactResponse } =
      yield github.rest.actions.listWorkflowRunArtifacts({
