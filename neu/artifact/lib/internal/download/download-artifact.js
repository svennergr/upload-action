...
exports.downloadArtifactInternal =
  exports.downloadArtifactPublic =
  exports.streamExtractExternal =
    void 0
...
function streamExtractExternal(url, directory) {
  return __awaiter(this, void 0, void 0, function* () {
    const client = new httpClient.HttpClient(
      (0, user_agent_1.getUserAgentString)()
    )
...
function downloadArtifactPublic(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    const downloadPath = yield resolveOrCreateDirectory(
    ...
    if (status !== 302) {
      throw new Error(
        `Unable to download artifact. Unexpected status: ${status}`
      )
    }
...
function downloadArtifactInternal(artifactId, options) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    artifact_twirp_client_1.internalArtifactTwirpClient)()
    const { workflowRunBackendId, workflowJobRunBackendId } = (0,
    util_1.getBackendIdsFromToken)()
    const listReq = {
...
function resolveOrCreateDirectory(
  downloadPath = (0, config_1.getGitHubWorkspaceDir)()
) {
  return __awaiter(this, void 0, void 0, function* () {
