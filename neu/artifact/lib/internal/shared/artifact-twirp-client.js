...
class ArtifactHttpClient {
  ...
  request(service, method, contentType, data) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const { body } = yield this.retryableRequest(() =>
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      while (attempt < this.maxAttempts) {
        ...
        try {
          ...
          ;(0, core_1.debug)(
            `Headers: ${JSON.stringify(response.message.headers, null, 2)}`
          )
          ...
          if (
            errors_1.NetworkError.isNetworkErrorCode(
...
function internalArtifactTwirpClient(options) {
  const client = new ArtifactHttpClient(
    ...
    options === null || options === void 0 ? void 0 : options.maxAttempts,
    options === null || options === void 0 ? void 0 : options.retryIntervalMs,
    options === null || options === void 0 ? void 0 : options.retryMultiplier
  )
