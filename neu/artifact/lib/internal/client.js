      ...
      try {
        ...
        if (options === null || options === void 0 ? void 0 : options.findBy) {
          const {
            ...
            downloadOptions = __rest(options, ['findBy'])
          return (0, download_artifact_1.downloadArtifactPublic)(
            artifactId,
            repositoryOwner,
            repositoryName,
            token,
        ...
        return (0, download_artifact_1.downloadArtifactInternal)(
          artifactId,
          options
        )
      } catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (options === null || options === void 0 ? void 0 : options.findBy) {
          ...
          return (0, list_artifacts_1.listArtifactsPublic)(
            workflowRunId,
            repositoryOwner,
            repositoryName,
            token,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (options === null || options === void 0 ? void 0 : options.findBy) {
          ...
          return (0, get_artifact_1.getArtifactPublic)(
            artifactName,
            workflowRunId,
            repositoryOwner,
            repositoryName,
