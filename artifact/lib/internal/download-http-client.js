...
class DownloadHttpClient {
  constructor() {
    this.downloadHttpManager = new http_manager_1.HttpManager(
      (0, config_variables_1.getDownloadFileConcurrency)(),
        ...
        parallelDownloads.map((index) =>
          __awaiter(this, void 0, void 0, function* () {
            while (currentFile < downloadItems.length) {
              ...
              if (core.isDebug()) {
                core.debug(
                  `File: ${++downloadedFiles}/${downloadItems.length}. ${currentFileToDownload.targetPath} took ${(perf_hooks_1.performance.now() - startTime).toFixed(3)} milliseconds to finish downloading`
                )
              }
  ...
  downloadIndividualFile(httpClientIndex, artifactLocation, downloadPath) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const headers = (0, utils_1.getDownloadHeaders)(
        'application/json',
        true,
        true
      )
          ...
          try {
            ...
            if (
              ...
              isAllBytesReceived(
                ...
                yield (0, utils_1.getFileSize)(downloadPath)
              )
            ) {
              return
            } else {
