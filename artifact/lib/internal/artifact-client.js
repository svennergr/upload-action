...
For more detailed logs during the artifact upload process, enable step-debugging: https://docs.github.com/actions/monitoring-and-troubleshooting-workflows/enabling-debug-logging#enabling-step-debug-logging`)
      ...
      const uploadSpecification = (0,
      upload_specification_1.getUploadSpecification)(name, rootDirectory, files)
      ...
      if (uploadSpecification.length === 0) {
        ...
        const response = yield uploadHttpClient.createArtifactInFileContainer(
          name,
          options
        )
  ...
  downloadArtifact(name, path, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (downloadSpecification.filesToDownload.length === 0) {
        ...
        yield (0, utils_1.createEmptyFilesForArtifact)(
