...
class UploadHttpClient {
  constructor() {
    this.uploadHttpManager = new http_manager_1.HttpManager(
      (0, config_variables_1.getUploadFileConcurrency)(),
  ...
  createArtifactInFileContainer(artifactName, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (options && options.retentionDays) {
        ...
        parameters.RetentionDays = (0, utils_1.getProperRetention)(
      ...
      const response = yield (0, requestUtils_1.retryHttpClientRequest)(
        ...
        parallelUploads.map((index) =>
          __awaiter(this, void 0, void 0, function* () {
            while (currentFile < filesToUpload.length) {
              ...
              if (core.isDebug()) {
                core.debug(
                  `File: ${++completedFiles}/${filesToUpload.length}. ${currentFileParameters.file} took ${(perf_hooks_1.performance.now() - startTime).toFixed(3)} milliseconds to finish upload`
                )
              }
  ...
  uploadFileAsync(httpClientIndex, parameters) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!isFIFO && totalFileSize < 65536) {
        ...
        const buffer = yield (0, upload_gzip_1.createGZipFileInBuffer)(
          parameters.file
        )
        ...
        uploadFileSize = yield (0, upload_gzip_1.createGZipFileOnDisk)(
          parameters.file,
          tempFile.path
        )
  ...
  uploadChunk(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const headers = (0, utils_1.getUploadHeaders)(
        'application/octet-stream',
        true,
        isGzip,
        totalFileSize,
        end - start + 1,
        (0, utils_1.getContentRange)(start, end, uploadFileSize),
        digest
      )
      ...
      while (retryCount <= retryLimit) {
        ...
        if ((0, utils_1.isSuccessStatusCode)(response.message.statusCode)) {
          ...
          (0, utils_1.isRetryableStatusCode)(response.message.statusCode)
        ) {
          core.info(
          ...
          ;(0, utils_1.isThrottledStatusCode)(response.message.statusCode)
            ? yield backOff(
                (0, utils_1.tryGetRetryAfterValueTimeInMilliseconds)(
